...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="relative py-12 pt-4 bg-[#141a2e] overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-start pt-10">
                    ...
                    <div className="space-y-10 lg:sticky lg:top-24">
                        ...
                        <div className="flex flex-wrap gap-4 pt-2 relative z-20 pointer-events-auto">
                            ...
                            {/* LinkedIn */}
                            <a href="https://www.linkedin.com/in/bagusrafi" target="_blank" rel="noopener noreferrer" className="relative w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.08] flex items-center justify-center group transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                                <LinkedInIcon className="w-6 h-6 md:w-8 md:h-8 text-white/60 group-hover:text-[#0A66C2] transition-colors duration-300" />
                                <div className="absolute inset-0 rounded-2xl bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                            </a>

                            {/* Email */}
                            <a href={`mailto:${t("contact.email")}`} className="relative w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.08] flex items-center justify-center group transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                                <MailIcon className="w-6 h-6 md:w-8 md:h-8 text-white/60 group-hover:text-blue-400 transition-colors duration-300" />
                                <div className="absolute inset-0 rounded-2xl bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                            </a>
                        </div>
                    </div>
